...
Finally, we'll define a MongoDB client using [its Node Driver](https://www.mongodb.com/docs/drivers/node/current/). This same client will be used throughout all of the schema chapters.
