...
We'll start with implementing [the basic GraphQL schema](/get-started#basic). This will help you get a basic understaning of what GraphQL is and how its Schema Definition Language (SDL) looks like.
